...
<div class="layout-px-spacing">
    ...
    <div class="page-header layout-spacing">
        <h2 class="pageHeading">Create FTL Consignment</h2>
    </div>


    <form class="general_form mtcheckload" method="POST" action="{{url($prefix.'/new-Ftl-create')}}" id="createconsignment"
        style="margin: auto;">
        ...
        <div class=" col-12 d-flex justify-content-end align-items-center" style="gap: 1rem; margin-top: 3rem;">
            ...
            <button type="submit" class="mt-2 btn btn-primary createFtlbtn disableme"
