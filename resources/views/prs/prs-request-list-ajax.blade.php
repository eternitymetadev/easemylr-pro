<p class="totalcount">Total Count: <span class="reportcount">{{ $prsRequests->total() }}</span></p>
            ...
            @if (count($prsRequests) > 0)
                @foreach ($prsRequests as $prsRequest)
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-warning" value="{{ $prsRequest->transaction_id }}"> Unpaid </button>
                        </td>
                    ...
                    if($prsRequest->is_approve == 0){
                        ...
                        <?php } else{ ?>
                        <td><button class="btn btn-warning" value="{{ $prsRequest->transaction_id }}"> Unknown
                            </button></td>
                        <?php } ?>
                        <!-- ------- End --------- -->
