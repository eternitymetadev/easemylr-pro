...
<div class="layout-px-spacing">
    <form class="general_form" method="POST" action="{{url($prefix.'/reserve-lr/update-reserve-lr')}}" id="updateorder"
        style="margin: auto; ">
        @csrf
                        ...
                        <div class=" col-sm-4 ">
                            ...
                            <select class="form-control form-small" id="select_regclient" name="regclient_id" disabled>
                                ...
                                <option value="{{ $client->id }}"
                                    {{ $client->id == $getconsignments->regclient_id ? 'selected' : ''}}>
                                    {{ucwords($client->name)}}
                                </option>
                                @endforeach
                                @endif
            ...
            <div class="col-lg-12 layout-spacing">
                ...
                <table border="1" width="100%">
                    <div class="row">
                        ...
                        <tr>
                            <td><input type="text" class="form-control form-small" value="Pesticide" name="description"
                                    list="json-datalist" onkeyup="showResult(this.value)"><datalist
                                    id="json-datalist"></datalist></td>
                            <td><input type="text" class="form-control form-small" value="Case/s" name="packing_type">
                            </td>
                        ...
                        <div class=" col-sm-4 ">
                            ...
                            <select class="form-control form-small my-select2" id="vehicle_no" name="vehicle_id"
                                ...
                                <option value="{{$vehicle->id}}"
                                    {{ $vehicle->id == $getconsignments->vehicle_id ? 'selected' : ''}}>
                                    {{$vehicle->regn_no}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class=" col-sm-3 ">
                            ...
                            <select class="form-control form-small my-select2" id="driver_id" name="driver_id"
                                ...
                                <option value="{{$driver->id}}"
                                    {{ $driver->id == $getconsignments->driver_id ? 'selected' : ''}}>{{$driver->name}}-{{$driver->phone ??
                                '-'}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class=" col-sm-4 ">
                            ...
                            <Input type="text" class="form-control form-small" name="transporter_name"
                                style="height: 43px;" value="{{$getconsignments->transporter_name}}">
                        </div>
                        <div class=" col-sm-3 ">
                            <p>Vehicle Type</p>
                            ...
                            <select class="my-select2 sete" id="vehicle_type" name="vehicle_type" tabindex="-1">
                                ...
                                <option value="{{$vehicle->id}}"
                                    {{ $vehicle->id == $getconsignments->vehicle_type ? 'selected' : ''}}>
                                    {{$vehicle->name}}</option>
                                </option>
                                @endforeach
                            </select>
