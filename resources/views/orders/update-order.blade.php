                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                ...
                                                <input type="text" class="form-control orderid" name="data[1][order_id]" value="{{$getconsignments->ConsignmentItem->order_id}}" readonly >
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                ...
                                                <input type="text" class="form-control invc_no" id="1"
                                                       name="data[1][invoice_no]" value="{{$getconsignments->ConsignmentItem->invoice_no}}" readonly >
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                <label>Invoice Date</label>
                                                <input type="date" class="form-control invc_date" name="data[1][invoice_date]" value="{{$getconsignments->ConsignmentItem->invoice_date}}" readonly >
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                ...
                                                <input type="number" class="form-control invc_amt"
                                                       name="data[1][invoice_amount]" value="{{$getconsignments->ConsignmentItem->invoice_amount}}" readonly >
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                <label>E-way Bill Number</label>
                                                <input type="number" class="form-control ew_bill" name="data[1][e_way_bill]" value="{{$getconsignments->ConsignmentItem->e_way_bill}}" readonly >
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group form-group-sm">
                                                <label>E-Way Bill Date</label>
                                                <input type="date" class="form-control ewb_date" name="data[1][e_way_bill_date]" value="{{$getconsignments->ConsignmentItem->e_way_bill_date}}" readonly >
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <input type="number" class="form-control net" name="data[1][item_data][0][net_weight]" value="{{$subitem->net_weight}}" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group form-group-sm">
                                                            <label>Gross Weight</label>
                                                            <input type="number" class="form-control gross" name="data[1][item_data][0][gross_weight]" value="{{$subitem->gross_weight}}" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group form-group-sm">
                                                            <label>Chargeable Weight</label>
                                                            <input type="number" class="form-control charge_wt" name="data[1][item_data][0][chargeable_weight]" value="{{$subitem->chargeable_weight}}" readonly>
                                                        </div>
