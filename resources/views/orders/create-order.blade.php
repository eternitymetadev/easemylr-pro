                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group form-group-sm">
                                                                    ...
                                                                    <input type="hidden" class="form-control"
                                                                        name="data[1][item_data][0][quantity]">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group form-group-sm">
                                                                    ...
                                                                    <input type="number" class="form-control net"
                                                                        name="data[1][item_data][0][net_weight]"
                                                                        readonly>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="form-group form-group-sm">
                                                                    ...
                                                                    <input type="number" class="form-control charge_wt"
                                                                        name="data[1][item_data][0][chargeable_weight]"
                                                                        readonly>
                                                                </div>
                                                            </td>
                                                            <td>
