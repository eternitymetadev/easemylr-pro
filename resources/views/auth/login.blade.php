...
<html lang="en">
	...
	<body>
		<div class="container mainContainer">
			<div
				class="mainRow row align-items-center justify-content-center"
				style="min-height: 100vh"
			>
				<div class="col-md-6">
					<div class="formBlock">
						<img src="{{asset('assets/shipbuddy-logo.svg')}}" class="logo" />
				...
				<div
					class="parentCompany col-md-6 align-self-start d-flex justify-content-end"
				>
					<img
						src="http://easemylr.in/assets/images/Eternity_Forwarder.png"
						class="logo"
