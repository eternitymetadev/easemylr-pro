                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col-lg-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <form class="general_form" method="POST" action="{{ url($prefix . '/users') }}"
                                id="createuser">
                                ...
                                <div class="form-group mb-4 baseclient" style="display: none;">
                                    ...
                                    ?>
                                        <option value="{{ $baseclient->id }}">{{ ucwords($baseclient->client_name) }}
                                        </option>
                                        <?php 
                                        }
                                    }
                ...
                success: function(res) {
                    ...
                    if (res.data) {
                        ...
                        $.each(res.data, function(key, value) {
                            $('#select_regclient').append('<option value="' + value.id + '">' +
                                value.name + '</option>');
                        });
                    }
                }
