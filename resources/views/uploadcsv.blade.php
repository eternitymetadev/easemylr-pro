    ...
    <div class="row layout-top-spacing">
        ...
        <div class="page-header">
            ...
            <form method="POST" action="{{url($prefix.'/consignees/upload_csv')}}" id="importfiles" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-12">
                        <h4 class="win-h4">Browse POD Zip Folder(pod_images)</h4>
                    </div>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-12">
                        <h4 class="win-h4">Browse to vendor routes</h4>
                    </div>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="file" name="vendor_route" id="vendor_route" class="vendor_route"> 
                    </div>
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <a class="btn btn-primary" href="{{url($prefix.'/sample-vendor-route')}}">Sample Download</a> 
                        </div>
                </div> --}}
                <?php } ?>
