...
.reportTemplateRow:hover,
.focusedReportTemplateRow {
    border-radius: 12px;
    border-bottom: none;
...
<div class="modal fade" id="createCustomReportModal" tabindex="-1" role="dialog"
    aria-labelledby="createCustomReportModalLabel" aria-hidden="true">
        ...
        <from class="modal-content">
            <div class="modal-header" style="border-bottom: none">
                ...
                <div class="d-flex align-items-center justify-content-end dateRangeBlock">
                    <div class="form-group">
                        <label for="fromDate">From</label>
                        <input class="form-control dateRangeInput" id="startdate" name="startdate" type="date" style="border-radius: 8px 0 0 8px" />
                    </div>
                    <div class="form-group">
                        <label for="toDate">To</label>
                        <input class="form-control dateRangeInput" id="enddate" name="enddate" type="date" style="border-radius: 0 8px 8px 0" />
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body" style="min-height: min(70vh, 700px)">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="baseclient_id" class="form-control form-control-sm my-select2" id="baseclient_id">
                            ...
                            <?php 
                                if(count($base_clients)>0) {
                                    foreach ($base_clients as $key => $base_client) {  
                                ?>
                ...
                <div class="form-row columnsSelection">
                    ...
                    <ul
                        style="width: 100%; display: grid; grid-template-columns: repeat(auto-fit, 250px); column-gap: 1rem; row-gap: 0.3rem; height: max-content">
                        <?php
                        ...
                        <li style="border-radius: 6px; padding: 6px 6px 6px 14px;">
                            <input type="checkbox" name="{{$columnsItem['label']}}" id="{{$columnsItem['label']}}" />
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="feather feather-chevron-down toggleChildCols">
                                <polyline points="6 9 12 15 18 9"></polyline>
                            </svg>
                            <ul style="display: none">
                                @foreach($columnsItem['child'] as $childColumnsItem)
                                <li>
                                    <input type="checkbox" name="{{$childColumnsItem['label']}}"
            ...
            <div class="p-3 d-flex justify-content-between align-items-center" style="gap: 1rem;">
                ...
                <div>
                    ...
                    <a href="<?php echo URL::to($prefix.'/custom-reports/export2'); ?>"
                        data-url="<?php echo URL::to($prefix.'/consignment-report2'); ?>"
                        class="consignmentReportEx btn btn-primary"
                        data-action="<?php echo URL::to($prefix.'/custom-reports/export2'); ?>" download><span><i class="fa fa-download"></i>Export Report</span></a>
                </div>
            </div>
        </from>
    </div>
