        ...
        @if(count($hrssheets)>0)
            @foreach($hrssheets as $hrssheet)
                ...
                <tr>
                        ...
                        @if ($hrssheet->status != 0)
                            @if (!empty($hrssheet->purchase_price))
                                <td><input type="checkbox" name="checked_drs[]" class="chkBoxClass"
                                           value="{{$hrssheet->hrs_no}}"
                                           data-price="{{$hrssheet->purchase_price}}"
                    ...
                    <td><p class="textWrap pb-0" style="max-width: 200px">{{$hrssheet->DriverDetail->name ?? '-'}}</p></td>
