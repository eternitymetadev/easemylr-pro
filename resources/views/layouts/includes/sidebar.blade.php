<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="consignment" data-parent="#accordionExample">
            <li>
                <div class="submenuListStyle"></div><a href="{{$prefixurl.'consignments/create'}}">Create Consignment </a>
            </li>
            <li>
    ...
    <li class="menu">
        ...
        <ul class="collapse submenu list-unstyled" id="vendors" data-parent="#accordionExample">
            <li>
                <div class="submenuListStyle"></div>
            ...
            <li>
                <div class="submenuListStyle"></div>  <a href="{{$prefixurl.'payment-report-view'}}">Payment Report -Transaction Id wise </a>
            </li>
            <li>
                <div class="submenuListStyle"></div>  <a href="{{$prefixurl.'drswise-report'}}">Payment Report - DRS id wise </a>
            </li>
    ...
    <li class="menu">
        ...
        <ul class="collapse submenu " id="forms" data-parent="#accordionExample">
            ...
            <li>
                <div class="submenuListStyle"></div><a href="{{url($prefix.'/settings/branch-address')}}"> Branch Address </a>
            </li>
