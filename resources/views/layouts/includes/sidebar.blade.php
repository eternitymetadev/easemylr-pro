<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu">
        <a href="{{$prefixurl.'route-list'}}" data-active="<?php if($segment == 'route-list'){?>true<?php }?>"
            class="dropdown-toggle">
            <div class="@if(str_contains($currentURL, 'route-list')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-map-pin">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
   ...
   if($authuser->role_id == 2 || $authuser->role_id ==3 || $authuser->role_id ==5){ ?>
    ...
    <li class="menu">
        <a href="#drsPayments" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
            <div
                class="@if(str_contains($currentURL, 'drs-paymentlist') || str_contains($currentURL, 'request-list') || str_contains($currentURL, 'payment-report-view') || str_contains($currentURL, 'prs-payment-report') || str_contains($currentURL, 'drswise-report')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul class="collapse submenu list-unstyled" id="drsPayments" data-parent="#accordionExample">
            ...
            <li>
                <div class="submenuListStyle"></div><a href="{{$prefixurl.'prs-payment-report'}}">PRS-Report -Transaction</a>
            </li>
            <li>
