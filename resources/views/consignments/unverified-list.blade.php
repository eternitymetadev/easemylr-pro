                ...
                <div class="widget-content widget-content-area br-6">
                    <div class=" mb-4 mt-4">
                        <div class="d-flex justify-content-between align-items-center px-3 pb-3" style="gap: 1rem;">
                            <button disabled="true" type="button" class="btn btn-warning disableDrs" id="create_edd"
                        ...
                        <table id="unverified-table" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td title="{{ $consignment->consigner_id}}"><p
                                        class="textWrap">{{ $consignment->consigner_id}}</p></td>
                                <td title="{{ $consignment->consignee_id}}"><p
                                        class="textWrap">{{ $consignment->consignee_id}}</p></td>
                                <td style="text-transform: uppercase">
                                    {{ $consignment->city ?? "-" }} - {{ $consignment->pincode ?? "-" }}<br/>
                                    Dist: {{ $consignment->consignee_district ?? "-" }}, {{ $consignment->zone ?? "-" }}
                                </td>
                                <td>
