...
@section('page-heading')POD View @endsection
@section('content')
...
<div class="layout-px-spacing" style="margin-top: 2rem">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <div class="mb-4 mt-4">
                    <div class="row mt-4 align-items-end px-3" style="margin-inline: auto; margin-bottom:15px;">
                        <div class="row align-items-end" style="flex: 1">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" id="regclient_id" name="regClient">
                                    <option>select</option>
                                    <?php if(count($regclients)>0){
                                        foreach($regclients as $regclient){ 
                                            // dd($consignment->ConsignerDetail->GetRegClient->id);
                                            ?>
                                            <option value="{{$regclient->id}}">{{$regclient->name}}</option>
                                        <?php }}?>
                                </select>
                            </div>
                    ...
                    <div class="main-table table-responsive">
                        @include('consignments.pod-list-ajax')
                    </div>
                </div>
            </div>
        </div>
...
jQuery(document).on('click', '#filter_reportall', function() {
    ...
    var regclient_id = $("#regclient_id").val();
...
jQuery(document).on('click', '.consignmentReportEx', function(event) {
    ...
    if (startdate)
        geturl = geturl + '?startdate=' + startdate + '&enddate=' + enddate + '&regclient_id=' + regclient_id;
    else if (search)
