            ...
            <tr>
                ...
                <td style="max-width: 260px; vertical-align: middle">
                    ...
                    <div style="min-height: 50px" class="d-flex align-items-center">
                        ...
                        <a class="edit @if($consignment->status == 1 && !empty($consignment->vehicle_id)) editButtonimg @endif editIcon swan-tooltip-left" 
                        data-tooltip="@if($consignment->status == 1 && !empty($consignment->vehicle_id)) Add Images @else Need to update status @endif"
