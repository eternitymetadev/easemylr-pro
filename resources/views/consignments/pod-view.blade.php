            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">POD View</a></li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="row mt-4" style="margin-left: 193px; margin-bottom:15px;">
                        ...
                        <div class="col-6">
                            ...
                            <a href="<?php echo URL::to($prefix . '/reports/export2'); ?>"
                                ...
                                style="margin-top: 31px; font-size: 15px; padding: 9px; width: 130px"
                                data-action="<?php echo URL::to($prefix . '/reports/export2'); ?>" download><span><i
