...
<div class="layout-px-spacing">
    ...
    <form class="general_form" method="POST" action="{{url($prefix.'/consignments/new-lr-create')}}"
        ...
        <div class="d-flex align-items-center px-2 pt-2 col-6">
            ...
            <div class="checkbox radio">
                <label class="check-label">FTL
                    <input type="radio" name="lr_type" value="0" onchange="toggleVehicleInfBlock()" class="" id="ftlChecked" checked>
                    <span class="checkmark"></span>
                </label>
            </div>
            <div class="checkbox radio ml-3">
                <label class="check-label">PTL
                    <input type="radio" name="lr_type" onchange="toggleVehicleInfBlock()" value="1">
                    <span class="checkmark"></span>
                </label>
            </div>
        </div>
