            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Mix Report</a></li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="row mt-4" style="margin-left: 193px; margin-bottom:15px;">
                        ...
                        <div class="col-6">
                            ...
                            <a href="<?php echo URL::to($prefix.'/export-mix-report'); ?>"
                                ...
                                style="margin-top: 31px; font-size: 15px; padding: 9px; width: 130px"
                                data-action="<?php echo URL::to($prefix.'/export-mix-report'); ?>" download><span><i class="fa fa-download"></i> Export</span></a>
