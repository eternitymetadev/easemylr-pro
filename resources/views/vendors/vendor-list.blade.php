...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <a href="{{'vendor/create'}}" class="btn btn-primary mt-3" style="margin-left:4px; font-size: 13px; padding: 6px 0px;">Add Vendor</a><?php $authuser = Auth::user(); 
                                if($authuser->role_id == 5){?> <button type="button" class="btn btn-primary ml-2 mt-3 dsd" >Import Vendor</button>
                                <?php } ?><a class="btn btn-success ml-2 mt-3" href="{{ url($prefix.'/export-vendor') }}">Export data</a>
                <div class="mb-4 mt-4">
