<p class="totalcount">Total Count: <span class="reportcount">{{ $paymentlist->total() }}</span></p>
            ...
            <tr>
                ...
                <th>Vehicle No
                    <a href="javascript:void();" class="vehicle-a" data-toggle="modal"
                        data-target="#search-paymentvehicle"><i class="fa fa-caret-down"></i>
                    </a>
                </th>
                <th>Gross Wt.</th>
                <th>Total Wt.</th>
            ...
            @if (count($paymentlist) > 0)
                @foreach ($paymentlist as $list)
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="checked_drs[]" class="chkBoxClass" value="{{ $list->drs_no }}" data-price="{{ $list->ConsignmentDetail->purchase_price }}"
                        ...
                        <td class="update_purchase_price" drs-no="{{ $list->drs_no }}">
