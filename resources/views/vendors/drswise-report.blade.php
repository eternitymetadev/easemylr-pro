            ...
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Drs Wise Report</a></li>
                    </ol>
                </nav>
            </div>
            <div class="widget-content widget-content-area br-6">
                <div class="mb-4 mt-4">
                    <h5 class="limitmessage text-danger" style="display: none;">You cannot download more than 30,000
                        ...
                        <input type="hidden" class="form-control" placeholder="Search" id="search"
                                data-action="<?php echo url()->current(); ?>">
                    <div class="row mt-4" style="margin-left: 193px; margin-bottom:15px;">
                        <div style="width: 300px">
                            <label>Search</label>
                            <input type="text" class="form-control" placeholder="Search" id="search_data">
                        </div>
                        <div class="col-sm-3">
                            <label>From</label>
                        ...
                        <div class="col-6">
                            ...
                            <a href="<?php echo URL::to($prefix.'/export-drswise-report'); ?>"
                                data-url="<?php echo URL::to($prefix.'/consignment-report2'); ?>"
                                class="consignmentReportEx btn btn-white btn-cstm"
                                style="margin-top: 31px; font-size: 15px; padding: 9px; width: 130px"
                                data-action="<?php echo URL::to($prefix.'/export-drswise-report'); ?>" download><span><i class="fa fa-download"></i> Export</span></a>
                    ...
                    <div class="main-table table-responsive">
                        @include('vendors.drswise-report-ajax')
                    </div>
                </div>
            </div>
        </div>
...
jQuery(document).on('click', '#filter_reportall', function() {
    ...
    var search = jQuery('#search_data').val();
