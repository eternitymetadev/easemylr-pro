        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="form-row mb-0 p-4" style="align-items: flex-end;">
                        <div class="form-group col-md-9 d-flex mb-0" style="align-items: flex-end;">
                            ...
                            <div class="form-group col-md-3 d-flex justify-content-end mb-0">
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary btn-cstm reset_filter ml-2"
                                    style="font-size: 15px; padding: 9px; width: 135px"
                        ...
                        <div class="form-group col-md-3 d-flex justify-content-end mb-0">
                            <a href="<?php echo URL::to($prefix . '/drs-payment/export'); ?>" data-url="<?php echo URL::to($prefix . '/drs-paymentlist'); ?>"
                                class="paymentReportEx btn btn-white btn-cstm"
                                style="font-size: 15px; padding: 9px; width: 130px" data-action="<?php echo URL::to($prefix . '/drs-payment/export'); ?>"
                                download><span><i class="fa fa-download"></i> Export</span></a>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="form-group col-md-4">
                            ...
                            <button type="button" class="btn btn-warning mt-4 ml-4 payment" style="font-size: 12px;"
                                disabled>Create Payment</button>
                            <?php }?>
                        </div>
                    </div>
                    @csrf
...
@section('js')
    <script>
        ...
        jQuery(document).on('click', '.paymentReportEx', function(event) {
            ...
            var search_vehicle = $('#search').val();
            var select_vehicle = $('#searchvehicle').val();

            // if(typeof(select_vehicle) === "undefined"){
            //     var select_vehicle = '';
            // }else{
            ...
            geturl = geturl + '?startdate=' + startdate + '&enddate=' + enddate+ '&search_vehicle=' + search_vehicle+ '&select_vehicle=' + select_vehicle;
