                ...
                <div class="modal-body px-4">
                    ...
                    if ($countbranch > 1) {?>
                            ...
                            <div class="form-group form-group-sm col-md-6">
                                ...
                                <select class="form-control my-select2" id="vendor_id_1" name="vendor_name"
                                    tabindex="-1">
                 ...
                 $bank_details = json_decode($vendor->bank_details, true);
                            ...
                            <div class="form-group form-group-sm col-md-12">
                                ...
                                <input class="styledInput" id="total_clam_amt_1" name="claimed_amount" value=""
                                    readonly>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="purchase_amt_prs">
                    <input type="text" class="form-control" id="prs_num" name="prs_no" value="">
                    <div class="form-row mb-0">
