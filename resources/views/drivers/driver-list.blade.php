                            ...
                            <div class="col-lg lead_bladebtop1_n pl-0">
                                ...
                                <?php $authuser = Auth::user();
                                    if($authuser->role_id ==1 ){ ?>
                                        <a style="font-size: 15px; padding: 9px;" href="<?php echo URL::to($prefix.'/'.$segment.'/export/excel'); ?>" class="downloadEx btn btn-primary" data-action="<?php echo URL::to($prefix.'drivers/export/excel'); ?>" download>
                                        <span><i class="fa fa-download"></i> Export</span></a>
                                    <?php } ?>
                                    <a href="{{'drivers/create'}}" class="btn btn-primary" style="font-size: 15px; padding: 9px;"><span><i class="fa fa-plus" ></i> Add New</span></a>
