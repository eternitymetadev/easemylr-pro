                        ...
                        <div class="summary-list summary-income" style="background-color: #00a2ae;">
                            <div class="summery-info ">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6><span
                                                style="font-size: 23px;">{{number_format((float)$gettoday_weightlifted,2, '.', '')}}
                                                (MT)</span><span class="summary-count"> </span>Today Net Weight lifted
                                        </h6>
                        ...
                        <div class="summary-list summary-profit" style="background-color: #ff4a43;">
                            ...
                            <div class="summery-info">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6><span
                                                style="font-size: 23px;">{{number_format((float)$getmonthly_weightlifted,2, '.', '')}}
                                                (MT)</span><span class="summary-count"> </span>Monthly Net Weight Lifted
                                        </h6>
                                        <p class="summary-average"></p>
                                    </div>
                                </div>
                        ...
                        <div class="summary-list summary-income" style="background-color: #8f44ad;">
                            <div class="summery-info">
                                ...
                                <div class="w-summary-details">
                                    <div class="w-summary-info">
                                        <h6><span
                                                style="font-size: 23px;">{{number_format((float)$gettoday_gross_weightlifted,2, '.', '')}}
                                                (MT)</span><span class="summary-count"> </span>Today's Gross Weight
                                            Lifted</h6>
                                        <p class="summary-average"></p>
                                    </div>
                                </div>
                        ...
                        <div class="summary-list summary-profit" style="background-color: #685aee;;">
                            ...
                            <div class="summery-info">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6><span
                                                style="font-size: 23px;">{{number_format((float)$getmonthly_gross_weightlifted,2, '.', '')}}
                                                (MT)</span><span class="summary-count"> </span>Monthly Gross Weight
                                            Lifted</h6>
                                        <p class="summary-average"></p>
                                    </div>
                                </div>
