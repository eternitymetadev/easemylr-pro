        ...
        <div class="page-header layout-spacing">
            <nav class="breadcrumb-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Widgets</a>
                    </li>
                </ol>
            </nav>
        </div>
                                ...
                                <div class="summery-info">
                                    ...
                                    <div class="w-summary-details">
                                        ...
                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{$gettoday_lr}}</span><span
                                                    class="summary-count smry"> </span>Today's LR</h6>
                                ...
                                <div class="summery-info">
                                    ...
                                    <div class="w-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <line x1="7" y1="7" x2="7" y2="7" style="color: #ffffff;"></line>
                                        </svg>
                                    </div>
                                    <div class="w-summary-details">

                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{$getcurrentmonth_lr}}</span><span
                                                    class="summary-count"></span>Current Month's LR</h6>
                                            <p class="summary-average" style="margin-top: 10px;"></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="summary-list summary-income" style="background-color: #00a2ae;">
                                <div class="summery-info ">
                                    ...
                                    <div class="w-summary-details">
                                        ...
                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{number_format((float)$gettoday_weightlifted,2, '.', '')}} (MT)</span><span
                                                    class="summary-count"> </span>Today Net Weight lifted</h6>
                            ...
                            <div class="summary-list summary-profit" style="background-color: #ff4a43;">
                                ...
                                <div class="summery-info">
                                    ...
                                    <div class="w-summary-details">
                                        ...
                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{number_format((float)$getmonthly_weightlifted,2, '.', '')}} (MT)</span><span
                                                    class="summary-count"> </span>Monthly Net Weight Lifted</h6>
                                            <p class="summary-average"></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="order-summary">
                            <div class="summary-list summary-income" style="background-color: #8f44ad;">
                                <div class="summery-info">
                                    ...
                                    <div class="w-summary-details">
                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{number_format((float)$gettoday_gross_weightlifted,2, '.', '')}} (MT)</span><span
                                                    class="summary-count"> </span>Today's Gross Weight Lifted</h6>
                                            <p class="summary-average"></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="summary-list summary-profit" style="background-color: #685aee;;">
                                ...
                                <div class="summery-info">
                                    ...
                                    <div class="w-summary-details">
                                        ...
                                        <div class="w-summary-info">
                                            <h6><span style="font-size: 23px;">{{number_format((float)$getmonthly_gross_weightlifted,2, '.', '')}} (MT)</span><span
                                                    class="summary-count"> </span>Monthly Gross Weight Lifted</h6>
                                            <p class="summary-average"></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-timeline timeline-new">
                                        ...
                                        <div class="t-content">
                                            <div class="t-uppercontent">
                                                <h5>{{$lastlr['consignee_detail']['nick_name'] ?? '-'}}<a
                                                        href="javscript:void(0);"><span></span></a></h5>
                                            </div>
