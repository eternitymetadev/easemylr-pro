        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Bulk Lr
                                    Downlaod</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="widget-content widget-content-area br-6">
                    <div class="mb-4 mt-4">
                        <form method="post" action="{{ url($prefix . '/download-contract-bulklr') }}">
                            @csrf
                            <table id="bulk-table" class="table table-hover" style="width:100%">
                                <div class="btn-group relative">
                                    <input class="btn btn-success bulk_loder" type="submit" value="Download Bulk Pdf"
                                        id="bulk" style="font-size: 13px; padding: 6px 0px;" disabled />
                                ...
                                <input type="checkbox" id="vehicle3" name="type[]" value="3" style="margin-left:9px;"
                                    checked>
                                <label for="vehicle3" style="margin-left:9px;"> TRIPLICATE</label>
                                <input type="checkbox" id="vehicle3" name="type[]" value="4"
                                    style="margin-left:9px;">
                                    ...
                                    @foreach ($consignments as $value)
                                        <tr>
                                            <td>
                                                ...
                                                -
                                                <?php }else{?>
                                                <input type="checkbox" name="checked_lr[]" class="checkLr"
