            ...
            @if (count($consignments) > 0)
                @foreach ($consignments as $consignment)
                    <tr>
                        ...
                        <td>
                            <div class="">
                                <div class=""><span style="color:#4361ee;">LR No:
                ...
                ?>
                    ...
                    if($consignment->invoice_no != null || $consignment->invoice_no != ''){ ?>
                            ...
                            <?php if($authuser->role_id !=7){?> |<a
                                ...
                                target="_blank" class="badge alert bg-cust shadow-sm">Print LR</a> <?php } ?>
                            <?php }else{ ?>
                            <a href="{{ url($prefix . '/print-sticker/' . $consignment->id) }}" target="_blank"
                                class="badge alert bg-cust shadow-sm">Print Sticker</a> <?php if($authuser->role_id !=7){?>| <a
                                href="{{ url($prefix . '/consignments/' . $consignment->id . '/print-view/2') }}"
                                target="_blank" class="badge alert bg-cust shadow-sm">Print LR</a> <?php } ?>
                            <?php } ?>
                        </td>
                        <?php } ?>
                        <td>
                            ...
                            <span class="badge alert bg-info shadow-sm"
                                lr-no="{{ $consignment->id }}">Acknowledged</span>
                            <?php }
                    elseif ($consignment->delivery_status == "Acknowledge") { ?>
                            <span class="badge alert bg-info shadow-sm"
                                lr-no="{{ $consignment->id }}">Acknowledged</span>
                            <?php }elseif ($consignment->delivery_status == "Cancel") { ?>
                            <span class="badge alert bg-info shadow-sm" lr-no="{{ $consignment->id }}"
                                style="background-color: #f40404 !important;
                        border-color: #f40404 !important;">Cancel</span>
                            <?php } else{ ?>
                            <span class="badge alert bg-success shadow-sm" lr-no="{{ $consignment->id }}">need to
                                update</span>
                            <?php } ?>
                        ...
                        // reattempt count
                        if ($consignment->reattempt_reason) {
                            $reattempt_count = ', Re:' . count(json_decode($consignment->reattempt_reason, true));
                        } else {
                            $reattempt_count = '';
                        }
                        ?>
                        <td>
                            ...
                            <span class="alert badge alert bg-secondary shadow-sm swan-tooltip"
                                data-tooltip="{{ $consignment->reason_to_cancel }}{{ $reattempt_count }}"
                                ...
                                <div class="statbox widget box box-shadow">
                                    <div class="widget-content widget-content-area icon-tab" style="padding: 0px;">
                                        ...
                                        <ul class="nav nav-tabs  mb-3 mt-3" id="iconTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active show" id="icon-txndetail-tab"
                                                    data-toggle="tab" href="#icon-txndetail-{{ $consignment->id }}"
                                                    role="tab" aria-controls="icon-txndetail"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="icon-otherdetail-tab" data-toggle="tab"
                                                    ...
                                                    aria-controls="icon-otherdetail" aria-selected="false"> Other
                                                    Details</a>
                                            </li>
                                        ...
                                        <div class="tab-content" id="iconTabContent-1">
                                            <div class="tab-pane fade show active"
                                                id="icon-txndetail-{{ $consignment->id }}" role="tabpanel"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <table id="" class="table table-striped">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Vehicle No</td>
                                                                    <td>{{ @$consignment->VehicleDetail->regn_no ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td>Driver Phone</td>
                                                                    <td>{{ @$consignment->DriverDetail->phone ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>No. of Boxes</td>
                                                                ...
                                                                <tr>
                                                                    <td>Gross Weight</td>
                                                                    <td>{{ $consignment->total_gross_weight ?? '' }}
                                                                    </td>
                                                                </tr>
                                            ...
                                            <div class="tab-pane fade" id="icon-timeline-{{ $consignment->id }}"
                                                role="tabpanel" aria-labelledby="icon-timeline-tab">
                                                <!-- modal code here -->

                                                <div class="d-flex flex-wrap">
                                                    <div class="append-modal" style="width: -webkit-fill-available">
                                                    </div>
