...
@section('content')
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="mb-4 mt-4">
                        ...
                        <div class="main-table table-responsive">
                            @include('contract-lr.pod-list-ajax')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="updateImageModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <form class="modal-dialog modal-dialog-centered" role="document" id="update_image_pod">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-wrap justify-content-center align-items-center">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="file" class="form-control" id="image-url" accept="image/*"
                ...
                <div class="modal-footer">
                    <button type="button" class="closeButton btn btn-outline-primary"
    ...
    <div class="modal fade" id="changemodeConfirm" tabindex="-1" role="dialog"
        aria-labelledby="updateImageModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Reason:</label>
                        <textarea class="form-control" name="reason_to_change_mode" id="reason_to_change_mode" rows="2"></textarea>
                        <div class="form-group">
