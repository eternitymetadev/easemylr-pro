            ...
            <div class="widget-content widget-content-area br-6">
                <form class="contact-info" method="POST" action="{{url($prefix.'/regclient-detail/update-detail')}}"
                    ...
                    <div class="form-row mb-0">
                        ...
                        <div class="form-group col-md-3">
                            <label for="exampleFormControlInput2">Order Email notification<span class="text-danger">*</span></label>
                            <div class="check-box d-flex align-items-center px-2" style="gap: 16px; height: calc(1.4em + 1.4rem + 2px)">
                                <div class="checkbox radio">
                                    <label class="check-label d-flex align-items-center" style="gap: 4px">
                        ...
                        <div class="form-group col-md-3">
                            <label for="exampleFormControlInput2">MIS Report3 Email notification<span class="text-danger">*</span></label>
                            <div class="check-box d-flex align-items-center px-2" style="gap: 16px; height: calc(1.4em + 1.4rem + 2px)">
                                <div class="checkbox radio">
                                    <label class="check-label d-flex align-items-center" style="gap: 4px">
                                        <input type="radio" value='1' name="is_misemail"
                                            {{ ($regclient_name->is_misemail=="1")? "checked" : "" }}>
                                        <span class="checkmark"></span>
                                        Yes
                                    </label>
                                </div>
                                <div class="checkbox radio">
                                    <label class="check-label d-flex align-items-center" style="gap: 4px">
                                        <input type="radio" name="is_misemail" value='0'
                                            {{ ($regclient_name->is_misemail=="0")? "checked" : "" }}>
                                        <span class="checkmark"></span>
                                        No
                                    </label>
                                </div>
                    ...
                    <div class="form-row mb-0">
                        <div class="form-group col-md-3">
                            <label for="exampleFormControlInput2">POD Email Notification<span class="text-danger">*</span></label>
                            <div class="check-box d-flex align-items-center px-2" style="gap: 16px; height: calc(1.4em + 1.4rem + 2px)">
                                <div class="checkbox radio">
                                    <label class="check-label d-flex align-items-center" style="gap: 4px">
                                        <input type="radio" value='1' name="is_podemail"
                                            {{ ($regclient_name->is_podemail=="1")? "checked" : "" }}>
                                        <span class="checkmark"></span>
                                        Yes
                                    </label>
                                </div>
                                <div class="checkbox radio">
                                    <label class="check-label d-flex align-items-center" style="gap: 4px">
                                        <input type="radio" name="is_podemail" value='0'
                                            {{ ($regclient_name->is_podemail=="0")? "checked" : "" }}>
                                        <span class="checkmark"></span>
                                        No
                                    </label>
                                </div>
