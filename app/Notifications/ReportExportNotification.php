...
class ReportExportNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->line('Please find the attached daily <strong>MIS2</strong> Report. This report has been generated by our system and includes data from the last ' . $subtractDays . ' days.')
                    ->attach($path, [
                        'as' => 'mis2.xlsx'
                    ]);
    }
