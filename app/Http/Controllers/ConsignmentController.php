...
// //////////   ACTIVE CANCEL STATUS DRS
    ...
    public function createNewLrForm()
    {
        ...
        return view('consignments.new-create-consignment', ['prefix' => $this->prefix, 'consigners' => $consigners, 'vehicles' => $vehicles, 'vehicletypes' => $vehicletypes, 'consignmentno' => $consignmentno, 'drivers' => $drivers, 'regionalclient' => $regionalclient, 'itemlists' => $itemlists]);
    }
