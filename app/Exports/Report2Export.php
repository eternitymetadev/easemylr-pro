...
class Report2Export implements FromCollection, WithHeadings, ShouldQueue
{
    ...
    public function collection()
    {
        ...
        ->with(
            ...
            'ConsigneeDetail.Zone:district,state',
            'ShiptoDetail.Zone:district,state',
        ...
        if($consignments->count() > 0){
            foreach ($consignments as $key => $consignment){
                ...
                $arr[] = [
                    ...
                    'consignee_state'     => @$consignment->ConsigneeDetail->state,
                    ...
                    'Ship_to_state'       => @$consignment->ShiptoDetail->state,
                    'invoice_no'          => $invno,
