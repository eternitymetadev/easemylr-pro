...
class CreateHrsPaymentHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hrs_payment_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hrs_payment_histories');
    }
}
